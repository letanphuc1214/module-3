...
<p>
    <a href="/missManagers?action=approve">the list has been approved
    </a>
</p>
<table border="1">
    <tr>
...
<%--        <th rowspan="2">Ảnh cá nhân</th>--%>
        ...
        <th rowspan="2" colspan="2">Chức năng</th>
...
<%--            <td>${missManager.getAnhCaNhan()}</td>--%>
            ...
            <td><a href="/missManagers?action=edit&id=${miss.getId()}">edit</a></td>
            <td><a href="/missManagers?action=delete&id=${miss.getId()}">delete</a></td>
